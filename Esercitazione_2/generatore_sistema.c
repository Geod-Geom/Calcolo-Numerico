	...
	for(i=0;i<N;i++)
	{
		for(j=0;j<N;j++)
		{
			if(j == i){
				...
				printf("%10.5lf", (double)((1.0+str[i-1]-'0')+(1.0+str[i]-'0'))/(double)((1.0+str[i-1]-'0')*(1.0+str[i]-'0')));
				fprintf(MatA,"% 10.5lf ", (double)((1.0+str[i-1]-'0')+(1.0+str[i]-'0'))/(double)((1.0+str[i-1]-'0')*(1.0+str[i]-'0')));}
			else {
				printf("%10.5lf", 0.);
